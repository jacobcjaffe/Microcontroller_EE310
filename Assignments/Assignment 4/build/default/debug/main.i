...
;---------------------
    ...
    MOVWF TRISD,0
    MOVLW 45 ; this is the measured temperature input ; place temperature inputs into data memory
    MOVWF measTemp, 0
    MOVLW 25; this is the reference temperature input
    MOVWF refTemp, 0


    MOVLW 45 ; this is the measured temperature input
    MOVWF 0x25
...
_measTempToBCDH:
    MOVLW 100
    SUBWF 0x25, 0
    BN _measTempToBCDM ; check if negative, move to next BCD digit
    MOVWF 0x25
    INCF measTempH
    BRA _measTempToBCDH
_measTempToBCDM:
    MOVLW 10
    SUBWF 0x25, 0
    BN _measTempToBCDL ; check if negative, move to next BCD digit
    MOVWF 0x25
    INCF measTempM
    BRA _measTempToBCDM
_measTempToBCDL:
    MOVFF 0x25, measTempL ; the remainder will be just the ones
...
_refTempToBCDH:
    MOVLW 100
    SUBWF 0x25, 0
    BN _refTempToBCDM ; check if negative, move to next BCD digit
    MOVWF 0x25
    INCF refTempH
    BRA _refTempToBCDH
_refTempToBCDM:
    MOVLW 10
    SUBWF 0x25, 0
    BN _refTempToBCDL ; check if negative, move to next BCD digit
    MOVWF 0x25
    INCF refTempM
    BRA _refTempToBCDM
_refTempToBCDL:
    MOVFF 0x25, refTempL ; the remainder will be just the ones
