...
;---------------------
    ...
    MOVWF PORTD
    MOVWF TRISD,0
    MOVLW -5 ; this is the measured temperature input ; place temperature inputs into data memory
    MOVWF measTemp, 0
    MOVLW 15 ; this is the reference temperature input
    MOVWF refTemp, 0


    MOVLW -5 ; this is the measured temperature input
    MOVWF 0x25
